...
const Contact = () => {
  ...
  const SkeletonLoader = () => (
    <div className='h-56 w-full bg-gray-200'>
      <div className='h-4 w-3/4 bg-gray-300 my-2 mx-auto rounded'></div>
      <div className='h-4 w-2/4 bg-gray-300 my-2 mx-auto rounded'></div>
      <div className='h-4 w-1/4 bg-gray-300 my-2 mx-auto rounded'></div>
    </div>
  )
